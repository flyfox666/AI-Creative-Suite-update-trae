  ...
  return (
    <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl shadow-2xl shadow-purple-500/10 p-6 md:p-10 border border-gray-700">
      <div className="text-center mb-12">
        ...
        <p className="mt-4 text-xl text-gray-400">{t('pricing.subtitle')}</p>
      </div>
        ...
        <div className="border border-gray-700 rounded-2xl p-8 flex flex-col">
          ...
          <ul className="mt-8 space-y-4 text-gray-300">
            <li className="flex items-start">
              ...
              <span>
                <span className="font-semibold text-white">{t('pricing.freePlan.feature1Value')}</span> {t('pricing.freePlan.feature1')}
              </span>
            </li>
            <li className="flex items-start">
              <CheckIcon className="w-6 h-6 text-green-500 mr-3 flex-shrink-0" />
              <span>
                <span className="font-semibold text-white">{t('pricing.freePlan.feature2Value')}</span> {t('pricing.freePlan.feature2')} {t('pricing.freePlan.feature2Cost')}
              </span>
            </li>
            <li className="flex items-start">
              <CheckIcon className="w-6 h-6 text-green-500 mr-3 flex-shrink-0" />
              <span>
                {t('pricing.freePlan.feature_image_studio_title')}
