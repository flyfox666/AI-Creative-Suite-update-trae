  ...
  return (
    <div className="space-y-8">
      <div className="text-center">
        <h2 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-cyan-500">{t('imageStudio.title')}</h2>
        <p className="mt-2 text-lg text-gray-400 max-w-2xl mx-auto">{t('imageStudio.subtitle')}</p>
      </div>
